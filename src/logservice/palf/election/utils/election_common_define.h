...
#define GLOBAL_ELECT_TIME 50_ms
...
inline int64_t CALCULATE_TIME_WINDOW_SPAN_TS() { return  common::is_bootstrap_in_single_mode()?10_ms : 2 * MAX_TST; }// 时间窗口的长度，为两个最大单程消息延迟， 默认为2s
